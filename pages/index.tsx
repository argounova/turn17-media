      ...
      <main>
        ...
        <div className="grid">
          <div className="card">
            ...
            <p>Landing pages, profiles, simple portfolios and more!</p>
          </div>

          <div className="card">
            <h3>4-6 Page Sites &rarr;</h3>
            <p>Entry level sites far from basic.  Dozens of custom options.</p>
          </div>

          <div className="card">
            <h3>Ground-Up Sites &rarr;</h3>
            <p>The sky is the limit.  Complete control of the design.</p>
          </div>

          <div className="card">
            <h3>Include Database &rarr;</h3>
            <p>Several products, services or blog posts? This is a must.</p>
          </div>
        </div>
      </main>
