const pricingStructure = [
    {
        ...
        price: '$800 USD',
        priceDetail: 'Flat rate, no additional fees',
        message: 'Login or register before getting started.',
        etc: 'ETC: 8-10 business days',
        btnText: 'Get Started',
        href: '/get-started',
    ...
    },
    {
        ...
        price: '$1300 USD*',
        priceDetail: 'Starting at $1300',
        message: 'Login or register before getting started.',
        etc: 'ETC: 14+ business days',
        btnText: 'Get Started',
        href: '/get-started',
        se1: 'Free domain for one year (up to $50 value)',
        se2: 'Free hosting for one year',
        se3: '90 days of tech support',
    ...
    // {
    //     tier: '4',
    //     title: 'Multi Page with Database',
    //     subtitle: 'Blog posts, products, etc. Also required if users need to login to the site.',
    //     price: '$1800 USD',
    //     etc: 'ETC: Ten business days',
    //     btnText: 'Get Started',
    // },
